...
//    }
    ...
    private void initComponents() {
        ...
        jComboBox5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "B.E", "M.E", "B.Tech", "M.Tech", "Ph.D" }));
...
//            AddPublicationRecord();
    ...
    private void kButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton8ActionPerformed
        ...
        {   
            ...
            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/management","root","root");
            //Prepared Statement
            PreparedStatement st = connection.prepareStatement("update faculty_details set fname=?,lname=?,email=?,address=? where username=?" ); //sus removed desihnation
